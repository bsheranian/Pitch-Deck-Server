...
public class EmailService extends ServiceTemplate<EmailRequest, EmailResult> {


    // Replace sender@example.com with your "From" address.
    // This address must be verified with Amazon SES.
    private static String SENDER = "Purple Pitch Decks <bsheranian1@gmail.com>";
    ...
    private static String SUBJECT = "Here's your Team Slide!";
    ...
    @Override
    public EmailResult doRequest(EmailRequest request) {
